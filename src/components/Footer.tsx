        ...
        <div className="grid gap-10 md:grid-cols-3">
          <div>
            ...
            <div className="mt-6 flex gap-3">
              ...
              <a href="https://www.tiktok.com/@coroa_cosmica?lang=en" target="_blank" rel="noopener noreferrer" className="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 hover:bg-accent-orange transition-colors" title="TikTok">
                <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24">

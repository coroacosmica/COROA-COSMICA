  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-cork-50 via-white to-forest-50">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-16 md:px-6 md:py-24">
        ...
        <h1 className="mt-6 max-w-3xl font-display text-4xl font-bold leading-tight text-forest-900 md:text-5xl lg:text-6xl">
          {t("title")}
        </h1>
        <p className="mt-6 max-w-2xl text-lg text-cork-700">{t("subtitle")}</p>
        <div className="mt-8 flex flex-wrap gap-4">
          <Link href="/catalogue" className="btn-primary">
            {t("ctaCatalogue")}
          </Link>
          <Link href="/virtual-sample" className="btn-secondary">
            {t("ctaSample")}
          </Link>
        </div>
